      ...
      >
        ...
        >
          <View>
            ...
            <Text className="text-white text-2xl font-black font-kanit leading-tight mt-1">
              Ready to crush{'\n'}your goals today?
            </Text>
          </View>
          ...
          <View className="flex-row items-center space-x-3">
             <TouchableOpacity 
              ...
              className="p-3 bg-card rounded-2xl border border-white/5 relative"
            >
              <Bell {...({ size: 22, stroke: "white" } as any)} />
            ...
            <TouchableOpacity 
              ...
              className="w-14 h-14 rounded-2xl bg-card border border-white/10 items-center justify-center overflow-hidden"
            >
              <Image 
                source={{ uri: 'https://i.pravatar.cc/150?u=fitzo' }} 
        ...
        {crowdForecast && (
          <Animated.View entering={FadeInUp.delay(600)}>
            <CrowdForecastCard forecast={crowdForecast} />
          </Animated.View>
        )}

        {/* Journey Stats */}
        <View className="flex-row justify-between items-center mb-6 px-1">
          <Text className="text-white text-xl font-bold font-kanit">My Journey</Text>
          <TouchableOpacity onPress={() => router.push('/edit-profile' as any)}>
             <Text className="text-primary text-xs font-bold font-kanit uppercase tracking-wider">View All</Text>
          </TouchableOpacity>
        </View>
        ...
        {!isWorkoutsLoading && workouts && workouts.length > 0 && (
          <View className="mt-4">
            <View className="flex-row justify-between items-center mb-6 px-1">
              <Text className="text-white text-xl font-bold font-kanit">Recommended Workouts</Text>
            </View>
